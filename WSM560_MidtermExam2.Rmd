...
*a) Trees are the straws of the landscape, moving water from the ground to the atmosphere thanks to hydraulic conductivity, moving the mass water from more to less. If land cover change from forest to agriculture , we can expect less evapotranspiration than forest but still some. Runoff would be greater with no forest, which will make peak flow greater*

*b) Man made structures would removed the evapotranspiration from crops, and impede infiltration of water. This will make the peak flow even greater than in the former example.*
...
*The experiment of Greyson et al modeled the soil wetting pattern in a catchment.  There are two prefer states, a dry soil state and a wet state. Dry soil refers to the state where evapotranspiration is greater than precipitation, typically found during the summer months. The wet state happens primary in winter when the precipitation is greater than evapotranspiration.*

*In the wet state, lateral water movement prevail, are not locally control because they follow capillary forces at any point in the catchment. This means that in wet conditions, water would move not following any other pattern but the physical elements of that that specific point in the catchment. That is why sketch A shows no pattern*
...
![Greyson Experiment](images/Midterm2_Q6.jpeg){width=40%}
...
![Flood Frequency Plot](images/Midterm2_Q7.png){width=40%}
...
*My favorite part of every lecture are the photographs at the begining, they are not only beautiful, but they serve as stage for the whole lecture. The lectures that blown my mind where the two water worlds, and the Greyson experiment, I could have never guess that water behaves so different acording to the medium they are and the time it passed*
